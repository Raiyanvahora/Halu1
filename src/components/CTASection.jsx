...
export default function CTASection({
  ...
  return (
    <section className="container-px">
      <Reveal className="relative overflow-hidden rounded-5xl bg-jade-800 px-6 py-14 text-center shadow-card sm:px-12 sm:py-20">
        <div className="pointer-events-none absolute -left-16 -top-16 h-64 w-64 rounded-full bg-jade-600/40 blur-3xl" />
        <div className="pointer-events-none absolute -bottom-20 -right-10 h-72 w-72 rounded-full bg-jade-500/30 blur-3xl" />
        <div className="relative mx-auto max-w-2xl">
          <span className="eyebrow text-white/80">
            <span className="h-px w-6 bg-white/60" /> Free, no-obligation quote
          </span>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            ...
            <Button href={`tel:${site.phoneIndiaHref}`} variant="glass" size="lg">
